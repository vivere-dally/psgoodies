#
# Module manifest for module 'PromiseGoodies'
#
...
FunctionsToExport = @('Complete-gPromise', 'Start-gPromise', 'Use-gCatch', 'Use-gFinally', 'Use-gThen')
...
AliasesToExport = @(
    'Complete-Promise', 'Complete', 'gComplete', 'Await',
